...
void unidades_de_comprimento()
{
    ...
    {
    case 1:
        valor_final = converter_metros(valor_atual, unidade_final);
        break; // unidade atual = metros
    case 2:
        valor_final = converter_centimetros(valor_atual, unidade_final);
        break; // unidade atual = centimetros
    case 3:
        valor_final = converter_milimetros(valor_atual, unidade_final);
        break; // unidade atual = milimetros
    default:;
    }
