...
void Conversor_De_Area()
{
    ...
    do
    {
        ...
        {
        case 1:
            valorEmMetros = valor * METRO_QUADRADO;
            break;
        case 2:
            valorEmMetros = valor * CENTIMETRO_QUADRADO;
            break;
        case 3:
            valorEmMetros = valor * KILOMETRO_QUADRADO;
            break;
        case 4:
            valorEmMetros = valor * HECTARE;
            break;
        case 5:
            valorEmMetros = valor * DECAMETRO_QUADRADO;
            break;
        case 6:
            valorEmMetros = valor * MILIMETRO_QUADRADO;
            break;
        case 7:
            valorEmMetros = valor * POLEGADA_QUADRADA;
            break;
        case 8:
            valorEmMetros = valor * PES_QUADRADOS;
            break;
        case 9:
            valorEmMetros = valor * JARDA_QUADRADA;
            break;
        case 10:
            valorEmMetros = valor * MILHA_QUADRADA;
            break;
        case 11:
            valorEmMetros = valor * ACRES;
            break;
        case 12:
            valorEmMetros = valor * UNIDADE_ASTRONOMICA;
            break;
        case 13:
            valorEmMetros = valor * PARSEC_QUADRADO;
            break;
        case 14:
            valorEmMetros = valor * ANO_LUZ_QUADRADO;
            break;
        default:
        ...
        {
        case 1:
            valorConvertido = valorEmMetros / METRO_QUADRADO;
            unidadeConvertidaStr = "m²";
            break;

        case 2:
            valorConvertido = valorEmMetros / CENTIMETRO_QUADRADO;
            unidadeConvertidaStr = "cm²";
            break;

        case 3:
            valorConvertido = valorEmMetros / KILOMETRO_QUADRADO;
            unidadeConvertidaStr = "km²";
            break;

        case 4:
            valorConvertido = valorEmMetros / HECTARE;
            unidadeConvertidaStr = "ha";
            break;

        case 5:
            valorConvertido = valorEmMetros / DECAMETRO_QUADRADO;
            unidadeConvertidaStr = "dam";
            break;

        case 6:
            valorConvertido = valorEmMetros / MILIMETRO_QUADRADO;
            unidadeConvertidaStr = "mm";
            break;

        case 7:
            valorConvertido = valorEmMetros / POLEGADA_QUADRADA;
            unidadeConvertidaStr = "in²";
            break;

        case 8:
            valorConvertido = valorEmMetros / PES_QUADRADOS;
            unidadeConvertidaStr = "ft²";
            break;

        case 9:
            valorConvertido = valorEmMetros / JARDA_QUADRADA;
            unidadeConvertidaStr = "yd²";
            break;

        case 10:
            valorConvertido = valorEmMetros / MILHA_QUADRADA;
            unidadeConvertidaStr = "mi²";
            break;

        case 11:
            valorConvertido = valorEmMetros / ACRES;
            unidadeConvertidaStr = "ac";
            break;

        case 12:
            valorConvertido = valorEmMetros / UNIDADE_ASTRONOMICA;
            unidadeConvertidaStr = "UA²";
            break;

        case 13:
            valorConvertido = valorEmMetros / PARSEC_QUADRADO;
            unidadeConvertidaStr = "pc²";
            break;

        case 14:
            valorConvertido = valorEmMetros / ANO_LUZ_QUADRADO;
